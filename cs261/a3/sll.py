...
class LinkedList:
    ...
    def add_front(self, value: object) -> None:
        """
        Adds value *value* to front of list.
        """
        # make new node:
        node = SLNode(value)
    ...
    def add_back(self, value: object) -> None:
        """
        Adds value *value* to back of list.
        >>> ll = LinkedList()
        >>> ll.add_front(2)
        >>> ll.add_front(3)
        >>> ll.add_back(4)
        ...
        if self.head.next.value == self.tail.value:
            ...
            while cur.value:
                ...
                if cur.next.value == self.tail.value:
                    temp = cur.next
                    cur.next = node
                    node.next = temp
                else:
                    self.head.next.add_back(value)
                    print("hi")
...
def get_at_index(self, index: int) -> object:
    ...
    # >>> d = DoublyList()
    # >>> d2 = DLNode(6)
    # >>> d2.next = d.backsentinel
    # >>> d.next = d2
    # >>> print(get_at_index(d, 0))

    """
    # checks if index is less than zero or greater than or equal to size, if yes than an exception is raised
